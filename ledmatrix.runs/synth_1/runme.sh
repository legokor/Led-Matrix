...
HD_PWD='D:/FPGA/ledmatrix/ledmatrix.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testLoader.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testLoader.tcl
