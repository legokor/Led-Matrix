...
HD_PWD='D:/FPGA/ledmatrix/ledmatrix.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testLoader.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testLoader.tcl -notrace
